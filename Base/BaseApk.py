...
if __name__ == '__main__':
    apkBaseinfo=ApkInfo(r"C:\Users\admin\Desktop\appium-prj\app\VBoard_V1.2.0.5_qa.apk").getApkBaseInfo()
    #apkName=ApkInfo(r"C:\Users\admin\Desktop\com.ximalaya.ting.android.apk").getApkName()
    print(apkBaseinfo)
    apkActivity=ApkInfo(r"C:\Users\admin\Desktop\appium-prj\app\VBoard_V1.2.0.5_qa.apk").getApkActivity()
    print(apkActivity)
