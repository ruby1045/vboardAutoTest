...
class ParametrizedTestCase(unittest.TestCase):
    ...
    def __init__(self, methodName='runTest', param=None):
        #将methodName传给unittest.TestCase类，参看HomeTest里的super(HomeTest, cls).setUpClass()
    ...
    #静态方法，调用时不需要新建一个对象，可直接 类名.方法名() 调用
    #被runnerCaseApp调用，runnerCaseAPP传入testCase_name(要测试的测试用例)和 devices信息，返回测试用例集
    @staticmethod
